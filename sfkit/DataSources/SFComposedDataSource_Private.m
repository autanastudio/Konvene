//
//  SFComposedDataSource_Private.m
//  SocialEvents
//
...
@implementation SFComposedMapping
...
{
    SFComposedMapping *result = [[[self class] allocWithZone:zone] init];
...
@implementation SFComposedViewWrapper

+ (id)wrapperForView:(UIView *)view mapping:(SFComposedMapping *)mapping
{
    if (!view)
        return nil;
    return [[SFComposedViewWrapper alloc] initWithView:view mapping:mapping];
}

- (id)initWithView:(UIView *)view mapping:(SFComposedMapping *)mapping
{
