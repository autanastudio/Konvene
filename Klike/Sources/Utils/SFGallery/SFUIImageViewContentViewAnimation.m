//
//  SFUIImageViewContentViewAnimation.m
//  SFGallery
//
...
@interface SFUIImageViewContentViewAnimation ()
...
@implementation SFUIImageViewContentViewAnimation
...
-(void)checkImageViewHasImage{
    if (!self.imageView.image) {
        ...
        self.imageView.image = SFImageFromView(view);
    }
}
